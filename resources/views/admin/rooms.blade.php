        ...
        <table class="min-w-full divide-y divide-gray-200">
          ...
          <tbody class="bg-white divide-y divide-gray-200">
           @foreach ($rooms as $room)
              ...
              <td class="px-6 py-4 whitespace-nowrap">
                <div class="text-sm text-gray-500">{{substr($room->description, 0 , 35)}}</div>
                <div class="text-sm text-gray-500">{{substr($room->description, 35 , 60)}} ...</div>
              </td>
              ...
              <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
               ...
               <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                ...
                <td class="px-6 py-4 whitespace-nowrap">
                <span class="px-2 py-2 inline-flex text-xs leading-5 font-semibold rounded bg-red-300 text-red-800">
                  Delete
                </span>
              </td>
